    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaRegistro', models.DateField(default=datetime.datetime(2023, 3, 25, 10, 21, 37, 66167))),
                ('ipUsuario', models.CharField(blank=True, default='192.168.1.9', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('A', 'Activo'), ('I', 'Inactivo')], default='A', max_length=1)),
                ('fechaRegistro', models.DateField(default=datetime.datetime(2023, 3, 25, 10, 21, 37, 67167))),
                ('ipUsuario', models.CharField(blank=True, default='192.168.1.9', max_length=100, null=True)),
                ('usuarioPosgradoFIM', models.CharField(blank=True, max_length=200, null=True)),
            ],
            options={
